...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'ingrid', 'ingrid@pic.com.br', '123', 'ingrid' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'ingrid')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'silva', 'silva@pic.com.br', '123', 'silva' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'silva')
`;
